...
export const translations = {
  ...
  // Login Card
   ...
   doctorLogin: 'Doctor login →',
    ...
    speciality: 'Specialité', degree: 'Degree / Qualification', specialities: 'Specialitées',
    ...
    logout: 'Logout', doctorPortal: 'Doctor Portal',
    ...
    totalAppointments: 'Total Appointments', completedApts: 'Completed',
    upcomingApts: 'Upcoming', totalEarnings: 'Total Earnings',
    todaySchedule: "Today's Schedule", noTodayApts: 'No appointments today',
    recentActivity: 'Recent Activity', monthlyEarnings: 'Monthly Earnings',
    aptStats: 'Appointment Overview', viewAll: 'View all →',
    allTime: 'all time', fromCompleted: 'from completed',
 
    // appointments
    allApts: 'All Appointments', total: 'total',
    all: 'All', pending: 'Pending', completed: 'Completed', cancelled: 'Cancelled', upcoming: 'Upcoming',
    patient: 'Patient', date: 'Date', time: 'Time',
    amount: 'Amount', payment: 'Payment', status: 'Status', actions: 'Actions',
    noApts: 'No appointments found', completeBtn: 'Complete', cancelBtn: 'Cancel',
    searchPatient: 'Search patient...',
 
    // earnings
    totalRev: 'Total Revenue', thisMonth: 'This Month',
    pendingPayments: 'Pending Payments', paidApts: 'Paid Appointments',
    earningsHistory: 'Earnings History', earningsChart: 'Revenue Trend',
    noEarnings: 'No earnings data yet',
 
    // profile
    myProfile: 'My Profile', editProfile: 'Edit Profile',
    saveChanges: 'Save Changes', saving: 'Saving...',
    name: 'Full Name', email: 'Email', speciality: 'Speciality',
    degree: 'Degree', experience: 'Experience', fees: 'Consultation Fees ($)',
    about: 'About', address: 'Address', profileUpdated: 'Profile updated successfully',
    uploadPhoto: 'Change Photo', available: 'Available for appointments',
    ...
    yesConfirm: 'Yes, Confirm', yesCancel: 'Yes, Cancel', close: 'Close',
  ...
  fr: {
    ...
    search: 'Rechercher...', filterSpeciality: 'Toutes spécialités',
    ...
    doctorWelcome: 'Bienvenue Docteur',
    doctorPanel: 'Portail Médecin',
     dashboard: 'Tableau de bord', appointments: 'Rendez-vous',
    earnings: 'Revenus', profile: 'Profil',
    logout: 'Déconnexion', doctorPortal: 'Portail Médecin',
    ...
    totalAppointments: 'Total Rendez-vous', completedApts: 'Terminés',
    upcomingApts: 'À venir', totalEarnings: 'Revenus totaux',
    todaySchedule: "Planning d'aujourd'hui", noTodayApts: "Aucun rendez-vous aujourd'hui",
    recentActivity: 'Activité récente', monthlyEarnings: 'Revenus mensuels',
    aptStats: 'Vue d\'ensemble', viewAll: 'Voir tout →',
    allTime: 'total', fromCompleted: 'des terminés',
 
    allApts: 'Tous les rendez-vous', total: 'total',
    all: 'Tous', pending: 'En attente', completed: 'Terminés', cancelled: 'Annulés', upcoming: 'À venir',
    patient: 'Patient', date: 'Date', time: 'Heure',
    amount: 'Montant', payment: 'Paiement', status: 'Statut', actions: 'Actions',
    noApts: 'Aucun rendez-vous trouvé', completeBtn: 'Terminer', cancelBtn: 'Annuler',
    searchPatient: 'Rechercher patient...',
 
    totalRev: 'Revenu total', thisMonth: 'Ce mois',
    pendingPayments: 'Paiements en attente', paidApts: 'Rendez-vous payés',
    earningsHistory: 'Historique des revenus', earningsChart: 'Tendance des revenus',
    ...
    name: 'Nom complet', email: 'Email', speciality: 'Spécialité',
    degree: 'Diplôme', experience: 'Expérience', fees: 'Honoraires ($)',
    about: 'À propos', address: 'Adresse', profileUpdated: 'Profil mis à jour',
    uploadPhoto: 'Changer la photo', available: 'Disponible pour des rendez-vous',
    ...
    yesConfirm: 'Oui, confirmer', yesCancel: 'Oui, annuler', close: 'Fermer',
